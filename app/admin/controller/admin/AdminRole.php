...
//            ->showCheckbox(true)->col(18);
        $form[] = Elm::treeChecked('auth','权限',[11,13])->data([Elm::treeData(11,'leaf 1-1-1')->children([Elm::treeData(13,'131313'),Elm::treeData(14,'141414')]),Elm::treeData(12,'leaf 1-1-2')])->col(12);
