...
class AdminRole extends AuthController
{
    ...
    public function edit($id = 0)
    {
        ...
        var_dump(rModel::get($rinfo['pid'])['auth']);
        $form[] = Elm::treeChecked('tree_data','选择权限',toIntArray(explode(",",$rinfo['tree_data'])))->data(aModel::selectAndBuildTree(0,$rinfo['pid'] != 0 ? rModel::get($rinfo['pid'])['auth'] : $this->adminId == 1 ? aModel::getIds() : $this->auth))->col(18);
