...
class SystemConfig extends AuthController
{
    ...
    {
        $form = array();
        $form[] = Elm::hidden('tab_id','分类名称',$request->param("tab_id"))->col(10);
        ...
        $form[] = Elm::textarea('parent','参数')->col(24);
        $form[] = Elm::textarea('remark','字段备注')->col(24);
        $form[] = Elm::input('upload_type','上传配置',0)->options([['label'=>'单选','value'=>0],['label'=>'多选','value'=>1]])->col(10);
